<template>
  <div>
    ...
    <el-dialog title="用户信息操作" v-model:visible="dialogFormVisible">
      <el-form :model="formData">
        ...
        <el-form-item label="是否启用" :label-width="formLabelWidth">
          <el-radio v-model:value="formData.IsAction" :label="true" border
            >是</el-radio
          >
          <el-radio v-model:value="formData.IsAction" :label="false" border
            >否</el-radio
          >
        </el-form-item>
      </el-form>
