<template>
  <div class="news">
    ...
    <!--  -->
    <el-dialog title="新闻编辑" v-model:visible="dialogFormVisible">
      <el-form :model="formData">
        ...
        <el-form-item label="新闻类别" :label-width="formLabelWidth">
          <el-radio v-model:value="formData.Type" :label="1">公司新闻</el-radio>
          <el-radio v-model:value="formData.Type" :label="2">行业动态</el-radio>
        </el-form-item>
      </el-form>
