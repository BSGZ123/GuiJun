      ...
      <div class="lacking">
        ...
        <div class="lacking-bottom">
          <div class="lacking-bottom-item">
            ...
            <p>
              质量检查、安全检查以抽查为主，难免存在遗漏，留下质量安全隐患。
            </p>
          </div>
          ...
          <div class="lacking-bottom-item">
            ...
            <p>
              数据统计、数据分析的缺失，无法为统计、分析、项目评估等工作提供数据支撑。
            </p>
          </div>
          ...
          <div class="lacking-bottom-item">
            ...
            <p>
              检查工作和检查记录文件脱节，无法做到同步对应；缺少影像文档，无法做到可追溯性。
            </p>
          </div>
        </div>
      </div>
...
.product{width:100%;height:100%;background-color:#14679f}.product-content{width:1240px;margin:0 auto;background-color:#fff}.p-video{width:1000px;margin:0 auto;padding:60px 0}/*//传统管理模式不足
*/
.lacking{height:420px;padding:20px 0;//margin:20px 0;.lacking-bottom {
    display: flex;
...
*/
.target{margin-top:50px;&-img {
    margin-top: 50px;
    text-align: center;
  }}/*//
*/
.modular{margin-top:50px;.modular-content {
    padding: 50px 50px;
    display: flex;
    justify-content: space-around;
  }}.modular-content-same{width:182px;height:405px;.same-item {
    height: 70px;
    padding: 10px 0;
    display: flex;
  ...
  }}.modular-content-center{width:355px;height:355px;img {
    width: 100%;
  }}/*//公共样式
*/
.title,
.eTitle{font-size:34px;font-weight:400;color:#333;text-align:center}.eTitle{font-size:30px;padding:10px 0}
</style>
